...
Task:
In cody-web-app, implement frontend Leave Management in three substeps: types/services/hooks/schemas, then pages/components, then i18n/error/permission polish. Stop after each substep.
