...
Task:
Implement HR Dashboard module. Step 1 only: dashboard queries, DTOs, permissions, summary projections, department distribution, contract expiration alerts, leave alerts. No frontend.
