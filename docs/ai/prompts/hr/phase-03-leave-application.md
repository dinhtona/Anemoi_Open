...
Task:
Implement Step 2 only for Leave Management Application Layer: CQRS commands/queries, validators, responses, Mapperly mappers, stable error codes, permissions. No controllers or UI. Stop for review.
