...
Task:
Implement Attendance → Payroll integration. Payroll calculations may consume attendance projections but reports must never query AttendanceRecord directly. Preserve snapshot architecture.
```
