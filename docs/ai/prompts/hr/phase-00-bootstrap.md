...
Task:
Bootstrap the HR bounded context as an Anemoi microservice named anemoi_hr. Create only Anemoi.Hr.ModelIds, Domain, Application, Infrastructure, Api. Do not implement features, endpoints, or UI. Stop for review.
