...
Task:
Implement Payroll Reporting and Export MVP. Add Payroll Run Summary, Payroll Item Detail, Payslip Summary reports. JSON and CSV must share projection infrastructure. Add ReportExportAuditLog entity, permissions, retention policy documentation, APIs, frontend integration and tests.
```
