...
Task:
Implement Promotion Management including EmployeePositionHistory, EmployeeGradeHistory, PromoteEmployee command, overlap validation, grade lookup abstraction, business timezone validation, APIs and tests. Stop for review.
```
