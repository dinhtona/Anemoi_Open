# Phase 04 Leave Api Events Worker
...
Task:
Implement Step 3 for Leave: endpoints, permissions, integration events, MassTransit publishing, monthly accrual worker with idempotency. No frontend. Stop for backend review.
