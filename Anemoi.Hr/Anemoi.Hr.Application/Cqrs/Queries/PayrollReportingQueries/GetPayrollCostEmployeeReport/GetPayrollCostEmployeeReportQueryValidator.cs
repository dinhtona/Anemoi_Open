...
public sealed class GetPayrollCostEmployeeReportQueryValidator : AbstractValidator<GetPayrollCostEmployeeReportQuery>
{
    public GetPayrollCostEmployeeReportQueryValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
