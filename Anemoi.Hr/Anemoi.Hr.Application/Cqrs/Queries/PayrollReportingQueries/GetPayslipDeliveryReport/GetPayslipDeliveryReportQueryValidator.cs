...
public sealed class GetPayslipDeliveryReportQueryValidator : AbstractValidator<GetPayslipDeliveryReportQuery>
{
    public GetPayslipDeliveryReportQueryValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
