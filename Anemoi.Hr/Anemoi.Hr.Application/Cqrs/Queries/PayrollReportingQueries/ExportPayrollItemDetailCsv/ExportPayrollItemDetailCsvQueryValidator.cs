...
public sealed class ExportPayrollItemDetailCsvQueryValidator : AbstractValidator<ExportPayrollItemDetailCsvQuery>
{
    public ExportPayrollItemDetailCsvQueryValidator()
    {
