...
public sealed class ExportPayrollItemDetailCsvHandler(
    ...
    : IQueryHandler<ExportPayrollItemDetailCsvQuery, ExportResult>
{
    public async Task<ExportResult> Handle(
        ExportPayrollItemDetailCsvQuery request,
