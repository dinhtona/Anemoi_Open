...
public sealed class GetPayrollItemDetailReportQueryValidator : AbstractValidator<GetPayrollItemDetailReportQuery>
{
    public GetPayrollItemDetailReportQueryValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
