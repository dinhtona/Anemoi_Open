...
public sealed class ExportPayrollCostEmployeeCsvQueryValidator : AbstractValidator<ExportPayrollCostEmployeeCsvQuery>
{
    public ExportPayrollCostEmployeeCsvQueryValidator()
    {
