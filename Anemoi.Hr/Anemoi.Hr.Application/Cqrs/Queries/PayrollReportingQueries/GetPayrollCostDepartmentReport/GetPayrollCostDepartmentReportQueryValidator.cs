...
public sealed class GetPayrollCostDepartmentReportQueryValidator : AbstractValidator<GetPayrollCostDepartmentReportQuery>
{
    public GetPayrollCostDepartmentReportQueryValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
