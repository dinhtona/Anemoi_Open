...
public sealed class CancelMyLeaveRequestHandler(
    ...
    : ICommandHandler<CancelMyLeaveRequestCommand, OneOf<None, ErrorDetailResponse>>
{
    public async Task<OneOf<None, ErrorDetailResponse>> Handle(CancelMyLeaveRequestCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var leaveRequest = await leaveRequestRepository.GetFirstByConditionAsync(
            x => x.Id == request.LeaveRequestId && x.EmployeeId == employee.Id,
