...
public sealed class CreateOvertimeRequestValidator : AbstractValidator<CreateOvertimeRequestCommand>
{
    public CreateOvertimeRequestValidator(HrSettings hrSettings)
    {
