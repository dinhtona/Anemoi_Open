...
public sealed class DeactivateOvertimeRuleHandler(
    ISqlRepository<OvertimeRule> repository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<DeactivateOvertimeRuleCommand, OneOf<SuccessResponse, ErrorDetailResponse>>
{
    public async Task<OneOf<SuccessResponse, ErrorDetailResponse>> Handle(
        DeactivateOvertimeRuleCommand request, CancellationToken cancellationToken)
    {
