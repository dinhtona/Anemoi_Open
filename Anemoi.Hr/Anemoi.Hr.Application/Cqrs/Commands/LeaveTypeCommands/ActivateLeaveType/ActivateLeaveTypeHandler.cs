...
public sealed class ActivateLeaveTypeHandler(
    ISqlRepository<LeaveType> repository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<ActivateLeaveTypeCommand, OneOf<SuccessResponse, ErrorDetailResponse>>
{
    public async Task<OneOf<SuccessResponse, ErrorDetailResponse>> Handle(
        ActivateLeaveTypeCommand request, CancellationToken cancellationToken)
    {
