...
public sealed class ChangeEmployeeGradeHandler(
    ISqlRepository<Employee> employeeRepository,
    ISqlRepository<EmployeeHistory> employeeHistoryRepository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<ChangeEmployeeGradeCommand, OneOf<None, ErrorDetailResponse>>
{
    public async Task<OneOf<None, ErrorDetailResponse>> Handle(
        ChangeEmployeeGradeCommand request, CancellationToken ct)
    {
        ...
        employee.GradeCode = request.NewGradeCode;
