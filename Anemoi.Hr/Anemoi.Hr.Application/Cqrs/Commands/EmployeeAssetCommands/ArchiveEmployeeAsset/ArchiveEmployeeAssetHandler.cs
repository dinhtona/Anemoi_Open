...
public sealed class ArchiveEmployeeAssetHandler(
    ISqlRepository<EmployeeAsset> assetRepository,
    ISqlRepository<EmployeeHistory> employeeHistoryRepository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<ArchiveEmployeeAssetCommand, OneOf<None, ErrorDetailResponse>>
{
    public async Task<OneOf<None, ErrorDetailResponse>> Handle(
        ArchiveEmployeeAssetCommand request, CancellationToken ct)
    {
