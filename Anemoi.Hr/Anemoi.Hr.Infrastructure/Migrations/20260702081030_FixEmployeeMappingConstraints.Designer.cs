...
namespace Anemoi.Hr.Infrastructure.Migrations
{
    ...
    [Migration("20260702081030_FixEmployeeMappingConstraints")]
    partial class FixEmployeeMappingConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.EmployeeAssets.EmployeeAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.EmployeeDocuments.EmployeeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.EmployeeNotes.EmployeeNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Employees.Employee", b =>
                {
                    ...
                    b.HasIndex("IdentityUserId")
                        .IsUnique()
                        .HasDatabaseName("ix_employees_identity_user_id");
                    ...
                    b.HasIndex("WorkEmail")
                        .IsUnique()
                        .HasDatabaseName("ix_employees_work_email");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Employees.EmployeeHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmployeeHistories", "Hr");
                });
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Employees.EmployeeOrganizationHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmployeeOrganizationHistories", "Hr");
                });
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Leaves.LeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.MasterData.LeavePolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ApplicableGradeCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("LeaveTypeId", "ApplicableGradeCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Overtime.OvertimeRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Probation.ProbationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Separations.EmployeeSeparation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SeparationTypeCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.ToTable("EmployeeSeparations", "Hr");
                });
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Transfers.EmployeeTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SourceGradeCode")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("TargetGradeCode")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("EmployeeTransfers", "Hr");
                });
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Leaves.LeaveAccrualRun", b =>
                {
                    ...
                    b.HasOne("Anemoi.Hr.Domain.MasterData.LeavePolicy", "LeavePolicy")
                        .WithMany()
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.MasterData.LeavePolicy", b =>
                {
                    b.HasOne("Anemoi.Hr.Domain.Leaves.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Probation.ProbationRecord", b =>
                {
                    ...
                    b.HasOne("Anemoi.Hr.Domain.Employees.Employee", "ReviewerEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("Anemoi.Hr.Domain.Transfers.EmployeeTransfer", b =>
                {
                    ...
                    b.HasOne("Anemoi.Hr.Domain.Departments.Department", "SourceDepartment")
                        .WithMany()
                        .HasForeignKey("SourceDepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Anemoi.Hr.Domain.Positions.Position", "SourcePosition")
                        .WithMany()
                        .HasForeignKey("SourcePositionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Anemoi.Hr.Domain.Departments.Department", "TargetDepartment")
                        .WithMany()
                        .HasForeignKey("TargetDepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Anemoi.Hr.Domain.Positions.Position", "TargetPosition")
                        .WithMany()
